...
public class Junction extends SimulatedObject {
	...
	void advance(int time) {
		if (_currentGreenTraffic != -1) {
			List<Vehicle> removable = _dqStrategy.dequeue(_listArrayVehicle.get(_currentGreenTraffic)); // llama a la
																										// funcion con
																										// la cola del
																										// semaforo
																										// actual
		...
		int newGreenTraffic = _lsStrategy.chooseNextGreen(_roadList, _listArrayVehicle, _currentGreenTraffic,
