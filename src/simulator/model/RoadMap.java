...
public class RoadMap {
	...
	void addRoad(Road r) {
		...
		if (!_stringJunctionMap.containsKey(r.getDest().getId()) && !_stringJunctionMap.containsKey(r.getSrc().getId()))
	...
	// Getters (aclaracion, el get en mapas devuelve null si el elemento no esta,
	// cumpliendo el parametro de github)
