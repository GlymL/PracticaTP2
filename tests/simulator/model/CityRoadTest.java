...
class CityRoadTest {
	...
	void test_1() {
		...
		assertEquals(72, v2.get_actualSpeed());

		// check correctness of totoal co2
		assertEquals(266, r1.get_contTotal());
		assertEquals(50, v1.get_contTotal());
		assertEquals(216, v2.get_contTotal());
		...
		// check correctness of totoal co2
		assertEquals(522, r1.get_contTotal());
		assertEquals(100, v1.get_contTotal());
		assertEquals(432, v2.get_contTotal());
	}
